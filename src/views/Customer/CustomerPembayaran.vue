<template>
    <div>
        <PageComponent>
            ...
            <form v-else @submit.prevent="tambahPembayaran">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                      <div class="flex">
                          <!-- PEMBAYARAN -->
                            <div>
                                <label for="METODE_PEMABAYARN" class="block text-sm font-medium text-gray-700">Metode Pembayaran</label>
                                    <select id="METODE_PEMBAYARAN" v-model="model.METODE_PEMBAYARAN" name="METODE_PEMBAYARAN" autocomplete="METODE_PEMBAYARAN" class="mt-1 focus:ring-pink-500 focus:border-pink-500 block shadow-sm sm:text-sm text-sm border-gray-300 rounded-md">
                                        <option>Cash</option>
                        ...
                        <!-- Rating AJR -->
                        <div class="mx-4 col-span-6 sm:col-span-3">
                        <label for="RATING_AJR" class="block text-sm font-medium text-gray-700">Rating AJR</label>
                              <input type="text" name="RATING_AJR" id="RATING_AJR" v-model="model.RATING_AJR" autocomplete="RATING_AJR" 
                            class="mt-1 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>

                        <!-- rATING DRIVER -->
                        <div v-if="model.ID_DRIVER != null" class=" col-span-6 sm:col-span-3">
                        <label for="RATING_DRIVER" class="block text-sm font-medium text-gray-700">Rating Driver</label>
                              <input type="text" name="RATING_DRIVER" id="RATING_DRIVER" v-model="model.RATING_DRIVER" autocomplete="RATING_DRIVER" 
                            class="mt-1 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                      </div>
